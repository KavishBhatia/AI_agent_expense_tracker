...
def _build_instruction(today: str) -> str:
    ...
    return (
        ...
        "'Action for socks' → merchant='Action', 'Tedi for toy' → merchant='Tedi', "
        "'Woolworth for shirt' → merchant='Woolworth', 'Amazon for headphones' → merchant='Amazon', "
        "'Rossmann for shampoo' → merchant='Rossmann', 'Kaufland for groceries' → merchant='Kaufland'). "
        ...
        "'at Action' → merchant='Action', 'at Tedi' → merchant='Tedi', 'at Woolworth' → merchant='Woolworth', "
        "'at Amazon' → merchant='Amazon', 'at Rossmann' → merchant='Rossmann', 'bei Kaufland' → merchant='Kaufland')\n"
        "- description: the item or purpose of the expense — when the message contains "
        "'[Store] for [item]' OR 'at [Store] for [item]', use the part after 'for' as the description. "
        "Examples: 'Aldi for pink night dress set' → description='pink night dress set', "
        "'5€ at Action for socks' → merchant='Action', description='socks', "
        "'15 euro at Tedi for toy car' → merchant='Tedi', description='toy car', "
        "'20€ at Amazon for headphones' → merchant='Amazon', description='headphones', "
        "'8€ at Rossmann for shampoo' → merchant='Rossmann', description='shampoo', "
        "'30€ at Kaufland for groceries' → merchant='Kaufland', description='groceries'\n"
